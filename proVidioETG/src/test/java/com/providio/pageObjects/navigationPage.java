...
public navigationPage(WebDriver rDriver ){
       ...
       //Menunewarrivals
		...
		public void ClickwoMensofOutfits(WebDriver driver){
		
			if(womensOutfits.isSelected()) {
				womensOutfits.click();
			}else {
				JavascriptExecutor js = (JavascriptExecutor) driver;
				js.executeScript("arguments[0].click();", womensOutfits);
			}
		}
		//clothing
		...
		public void ClickwoMensofBraceletss(WebDriver driver){

			if(womenBracelets.isDisplayed()) {
				womenBracelets.click();
			}else if(womenBracelets.isDisplayed()) {
				JavascriptExecutor js = (JavascriptExecutor) driver;
				js.executeScript("arguments[0].click();", womenBracelets);
			}
		}
		//necklaces
